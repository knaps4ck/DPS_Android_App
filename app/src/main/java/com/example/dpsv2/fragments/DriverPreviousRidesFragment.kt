 ...
 * Use the [DriverPreviousRidesFragment.newInstance] factory method to
...
class DriverPreviousRidesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DriverPreviousRidesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DriverPreviousRidesFragment().apply {
